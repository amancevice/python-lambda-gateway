...
class TestLambdaRequestHandler:
    def setup(self):
        ...
        self.subject.get_event_v1 = \
            lambda x: LambdaRequestHandler.get_event_v1(self.subject, x)
        self.subject.get_event_v2 = \
            lambda x: LambdaRequestHandler.get_event_v2(self.subject, x)
    ...
    @pytest.mark.parametrize(('proxy', 'version'), [
    ...
    @pytest.mark.parametrize(('verb', 'path', 'version', 'params'), [
